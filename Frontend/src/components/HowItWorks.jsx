                ...
                <div className='flex w-lg flex-col gap-7'>
                    ...
                    <div className="w-full gap-2 flex justify-between ">
                        ...
                        <div className='w-full flex items-center gap-4 bg-white border rounded-xl p-4 border-neutral-200'>
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-neutral-900">Sign Up and create Account</h2>
                                <p className="text-neutral-600">Fill out your details and showcase your skills.</p>
                            </div>
                        </div>
                    </div>
                    <div className=" w-full gap-2 flex justify-between ">
                        <div className='w-full flex items-center gap-4 bg-white border rounded-xl p-4 border-neutral-200'>
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-neutral-900">Upload Your Portfolio</h2>
                                <p className="text-neutral-600">Add your resume, videos, and more.</p>
                            </div>
                        </div>
                    ...
                    <div className=" w-full gap-2 flex justify-between ">
                        ...
                        <div className='w-full flex items-center gap-4 bg-white border rounded-xl p-4 border-neutral-200'>
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-neutral-900">Get Discovered</h2>
                                <p className="text-neutral-600">Let employers find and contact you.</p>
                            </div>
                        </div>
                    </div>
                </div>
